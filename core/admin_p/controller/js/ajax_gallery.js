	...
	function getGallery(){
		...
		function getContent(data){
			...
			$.each(data, function(adata){
				text+='<li class="ui-state-default" id='+this.id+'><div class="album_line well"><span class="gallery_name_lang1"><a href="index.php?content=album&id='+this.id+'">'+this.name_lang1+'</a></span><div class="gallery_right"><span class="gallery_date"><b>Дата создания:</b> '+this.date+'</span><span class="gallery_del"><a href="controller/album_del.php?id='+this.id+'" class="del"><i class="icon-trash"></i></a></span></div></div></li>';
				i++;
			});
