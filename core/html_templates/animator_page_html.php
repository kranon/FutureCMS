...
<table width="698"  cellspacing="0" cellpadding="0" align="center">
  <tr>
	...
	<td class="kol_prawa">
		...
		<tr><td class="text">
			 <?php
			if ($group==4 || $group==1 || $group==2){
				 echo $db->TextRead($link, $lang);
				 echo $form;
			 }
			 else{
				echo 'Гэтая старонка толькі для аніматара! Зайдзiце ў сiстэму альбо зарэгiструйцесь!';
			}
			?>
		</td></tr>
		</table>
  ...
  <tr><td colspan="2" class="menu_bot">
		...
		<a href="index.php" class="granat"><?php echo $word[25];?></a>
		<img src="design/iko_mb.gif" align="absmiddle" />
		<script type="text/javascript">mailer('kranon', 'tut.by', ' class="granat"', '<?php echo $word[26];?>', '');</script>
		<img src="design/iko_mb.gif" align="absmiddle" />
		<a href="Avtorizatsiya.php" class="granat"><?php echo $word[27];?></a>
		<img src="design/iko_mb.gif" align="absmiddle" />
